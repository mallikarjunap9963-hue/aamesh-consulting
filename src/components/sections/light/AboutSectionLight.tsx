...
export function AboutSectionLight({ onNavigateToServices }: AboutSectionLightProps) {
  ...
  return (
    <section id="about" className="relative py-8 md:py-12 bg-white w-full overflow-hidden border-t border-slate-200/80">
      <div className="relative z-10 w-full px-6 md:px-12 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* LEFT COLUMN: ABOUT US IMAGE */}
          <div className="w-full relative group">
            <div className="relative rounded-3xl overflow-hidden border border-slate-200/80 shadow-[0_25px_60px_-15px_rgba(1,40,84,0.22)] group-hover:shadow-[0_30px_70px_-15px_rgba(183,120,5,0.3)] bg-white group-hover:border-amber-500/40 transition-all duration-500">
              <img
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-[44px] font-bold tracking-tight text-[#012854] leading-[1.12] mb-6 font-sans">
              ...
              <span className="text-gradient-primary-light font-bold">Real Solutions.</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8">
              {valuePoints.map((title, idx) => (
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-[#012854] uppercase tracking-wider">{title}</span>
                </div>
              ))}
            </div>
            ...
            <div>
              <button
                ...
                className="bg-gradient-to-r from-[#012854] via-[#012F62] to-[#B77805] hover:from-[#012F62] hover:via-[#B77805] hover:to-[#CE9116] text-white font-bold px-8 py-4 rounded-full text-xs md:text-sm tracking-wider uppercase shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 inline-flex items-center gap-3 cursor-pointer group"
              >
                <span>View More</span>
